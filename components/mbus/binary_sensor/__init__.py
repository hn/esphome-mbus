...
MBusBinarySensor = mbus_ns.class_(
    "MBusBinarySensor", binary_sensor.BinarySensor, cg.Component
)
...
CONFIG_SCHEMA = (
    binary_sensor.binary_sensor_schema(MBusBinarySensor)
    .extend(
        {
            ...
            cv.Optional(CONF_FUNCTION, default="instantaneous"): cv.enum(
